...
# ASI-Evolve Metrics
asi_evolve_mutation_count = Counter(
    "pythia_asi_evolve_mutations_total", "Total strategies generated by ASI-Evolve"
)
asi_evolve_last_score = Gauge(
    "pythia_asi_evolve_last_score", "Score of the latest evolved candidate"
)
asi_evolve_cooldown_remaining = Gauge(
...
class MetricsExporter:
    ...
    def record_asi_mutation(self, score: float):
        """Record an ASI-Evolve mutation event."""
        asi_evolve_mutation_count.inc()
        asi_evolve_last_score.set(score)

    def update_asi_cooldown(self, seconds: float):
