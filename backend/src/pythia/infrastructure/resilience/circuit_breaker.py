...
try:
    ...
    class CircuitBreaker:
        ...
        def __init__(self, fail_max, reset_timeout, excluded_exceptions):
            pass
...
class BusinessException(Exception):
    ...
    pass
ai_breaker = CircuitBreaker(fail_max=3, reset_timeout=timedelta(seconds=60), excluded_exceptions=(BusinessException,))
financial_api_breaker = CircuitBreaker(fail_max=5, reset_timeout=timedelta(seconds=120), excluded_exceptions=(BusinessException,))
