...
from app.core.integrity import integrity_ledger
...
async def attack_vector_validity():
    ...
    attacks = [
        {"action": "buy", "symbol": "SCAM", "quantity": 100, "price": 10}, # Banned symbol
        {"action": "sell", "symbol": "BTC/USD", "quantity": 1000, "price": 50000}, # Exceeds max qty
        {"action": "buy", "symbol": "ETH/USD", "quantity": 0.1, "price": -500}, # Logical fallacy
        {"action": "buy", "symbol": "BTC/USD", "quantity": 0.1, "price": 50000} # Valid
    ]
