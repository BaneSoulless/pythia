...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_learning_experiences_id"), "learning_experiences", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "performance_metrics", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_model_checkpoints_id"), "model_checkpoints", ["id"], unique=False
    )
