...
ai_predictions_total = Counter(
    'trading_bot_ai_predictions_total',
...
ai_training_duration = Summary(
    'trading_bot_ai_training_duration_seconds',
    'Time spent training AI model'
)

ai_epsilon = Gauge(
    'trading_bot_ai_epsilon',
...
min_balance_violations = Counter(
    'trading_bot_min_balance_violations_total',
    'Attempted trades below minimum balance'
)
...
def metrics_endpoint() -> Response:
    ...
    Add to FastAPI:
    ```python
    from app.services.prometheus_metrics import metrics_endpoint
