...
class MarketDataService:
    ...
    def get_quote(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # fast_info is faster than info for basic data
            ...
            if price is None:
                ...
                prev_close = price # Approximate if no prev close
            ...
            result = {
                ...
                "volume": 0, # Volume not always available in fast_info
            ...
            # Return empty/zero structure on error to prevent crashes
            return {
                "symbol": symbol,
                "price": 0.0,
                "change": 0.0,
    ...
    def get_historical_data(
        ...
        try:
            ticker = yf.Ticker(symbol)
            # Fetch slightly more to ensure we have enough days
            ...
            for date, row in history.iterrows():
                data.append({
                    ...
                    "volume": int(row['Volume']) if 'Volume' in history.columns else 0
                })
