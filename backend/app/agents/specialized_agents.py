...
class RiskManagementAgent:
    ...
    def assess_trade_risk(
        ...
        # Calculate risk score based on volatility and size
        risk_score = (position_pct / self.max_position_size) * symbol_volatility
        
        approved = risk_score < 0.7  # Approve if risk score below threshold
        
        return {
            "approved": approved,
            "risk_score": risk_score,
            "position_pct": position_pct,
            "reason": "Acceptable risk" if approved else f"Risk score {risk_score:.2f} too high"
        }
